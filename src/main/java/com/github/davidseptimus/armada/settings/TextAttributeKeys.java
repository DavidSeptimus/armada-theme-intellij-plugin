...
public final class TextAttributeKeys {
    ...
    public static final TextAttributesKey YAML_SINGLE_QUOTED_STRING = TextAttributesKey.createTextAttributesKey("YAML_SINGLE_QUOTED_STRING");
    ...
    public static final TextAttributesKey CSS_PERCENT = TextAttributesKey.createTextAttributesKey("CSS.PERCENT");
    public static final TextAttributesKey CSS_IDENTIFIER_TERM = TextAttributesKey.createTextAttributesKey("CSS.TERM_IDENTIFIER");
