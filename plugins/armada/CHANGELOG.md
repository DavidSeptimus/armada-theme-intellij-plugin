...
- Log files, including the IDE's own logs, color each log level with the theme's own colors instead of the diff colors

### Changed

- Requires IntelliJ-based IDEs 2025.3 or newer
- Theme color updates and fixes
- Islands themes no longer draw borders around islands, tool window headers, and the editor tab strip, matching the look of JetBrains' Air themes. To add them back, use [InfiniTint Theme Tuner](https://plugins.jetbrains.com/plugin/33404-infinitint-theme-tuner)

### Fixed

- Changed lines in diffs keep their syntax colors instead of switching to a flat diff foreground
...
[Unreleased]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v1.2.0...HEAD
[1.2.0]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v0.8.0...v1.0.0
[0.8.0]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v0.7.1...v0.8.0
[0.7.1]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v0.6.0...v0.7.1
[0.6.0]: https://github.com/DavidSeptimus/armada-theme-intellij-plugin/compare/v0.5.2...v0.6.0
